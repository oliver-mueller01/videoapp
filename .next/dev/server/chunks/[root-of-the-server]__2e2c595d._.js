...
;
;
const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
async function POST(req) {
    try {
        const data = await req.json();
        const { title, creator, videoUrl, thumbnail } = data;
        if (!title || !videoUrl) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2e2c595d._.js.map
...
"[project]/videoapp/videoapp/app/api/videos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const video = await __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].videoapp_videos.create({
            data: {
                title: data.title,
...
async function GET() {
    try {
        const videos = await __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].videoapp_videos.findMany({
            orderBy: {
                uploadedAt: "desc"
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(videos);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3aa9bcf._.js.map
...
"[project]/videoapp/videoapp/lib/generated/prisma/runtime/library.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function ms() {
    return M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../");
}
var xh = "libquery-engine";
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-darwin");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-darwin-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-debian-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-debian-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-debian-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-linux-static-x64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-linux-static-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query-engine-rhel-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-darwin.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-linux-musl.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../query_engine-windows.dll.node");
...
async function ml(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime/library.js").match(Qm()) === null, c = {
        searchedLocations: i,
...
async function Wm(e, r) {
    let t = await ir(), n = [], i = [
        r.dirname,
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), ".."),
        r.generator?.output?.value ?? ("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"),
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime"), "../../../.prisma/client"),
        "/tmp/prisma-engines",
        r.cwd
    ];
    ("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(ms());
    for (let o of i){
...
"[project]/videoapp/videoapp/lib/generated/prisma/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/videoapp/videoapp/lib/generated/prisma/runtime/library.js [app-route] (ecmascript)");
const Prisma = {};
...
config.dirname = ("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma"), 'schema.prisma'))) {
...
const { warnEnvConflicts } = __turbopack_context__.r("[project]/videoapp/videoapp/lib/generated/prisma/runtime/library.js [app-route] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma"), "query_engine-windows.dll.node");
path.join(process.cwd(), "lib/generated/prisma/query_engine-windows.dll.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/videoapp/videoapp/lib/generated/prisma"), "schema.prisma");
path.join(process.cwd(), "lib/generated/prisma/schema.prisma");
}),
"[project]/videoapp/videoapp/lib/prisma.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/videoapp/videoapp/lib/generated/prisma/index.js [app-route] (ecmascript)");
;
const globalForPrisma = globalThis;
const prisma = globalForPrisma.prisma ?? new __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]({
    log: [
        "error",
        "warn"
    ]
...
"[project]/videoapp/videoapp/app/api/videos/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/videoapp/videoapp/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/videoapp/videoapp/lib/prisma.ts [app-route] (ecmascript)");
;
;
async function GET(req, context) {
    ...
    ;
    if (!id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Missing ID"
        }, {
            status: 400
        });
    ...
    try {
        const video = await __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].videoapp_videos.findUnique({
            where: {
                id
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(video);
    } catch (error) {
...
async function PUT(req, context) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].videoapp_videos.update({
            where: {
                id
            },
            data
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updated);
    } catch (error) {
...
async function DELETE(req, context) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$videoapp$2f$videoapp$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].videoapp_videos.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7713e0c9._.js.map